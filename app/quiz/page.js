...
function estimateMarketRange(answers) {
  ...
  // Title boost for senior/lead/director/vp/manager
          ...
          <div className="max-w-[640px] mx-auto">
            ...
            {!emailSubmitted ? (
              ...
              <div className="bg-white rounded-2xl border border-border p-8 text-center">
                ...
                <p className="text-muted text-sm mt-2">You're on the list! Check your email for negotiation tips.</p>
              </div>
            )}
          </div>
        </div>
