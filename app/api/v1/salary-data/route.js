// ============================================
// SalaryPrep — Partner API: Salary Data
// ============================================
// GET /api/v1/salary-data?company=google&role=software-engineer
//
// Returns ONLY data parsed from markdown research files.
// NEVER generates, estimates, or fabricates any data.
...
// Path traversal protection: only allow alphanumeric + hyphens
...
export async function GET(request) {
  ...
  if (!company) {
    return NextResponse.json(
      { error: 'Missing required parameter: company. Usage: /api/v1/salary-data?company=google&role=software-engineer' },
      { status: 400 }
    );
  }

  if (!isValidSlug(company)) {
    return NextResponse.json(
