  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setEmail(form.email);
        setSubmitted(true);
        if (typeof gtag === 'function') gtag('event', 'playbook_generated', { type: 'raise' });
      } else {
    ...
    return (
      <div className="min-h-screen bg-paper flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-blue/20 text-left">
            ...
            <div className="bg-blue/10 rounded-xl p-4 text-center mt-4">
              <p className="text-xs text-muted uppercase tracking-wider mb-1">Discount Code</p>
              <p className="font-mono text-2xl font-bold text-blue tracking-wider">FIRST30</p>
    ...
    <div className="min-h-screen bg-paper">
      ...
      <div className="pt-28 pb-20 px-6 max-w-[680px] mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {loading && (
            <div className="bg-blue-light rounded-xl p-4 text-center text-sm text-blue">
