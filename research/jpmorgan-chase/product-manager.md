...
data_sources:
  ...
  - Blind
  - TeamBlind
negotiation_dna_summary: "`Core Infrastructure` `Systemic Pay Band` `AI Core Expense` `Public Equity (NYSE: JPM)` `$4.1T+ Assets` `Product Strategy` `Revenue Ownership` `Regulatory Navigation`"
---
...
- [JPMorgan Chase 2025 Annual Report — Digital & Product Strategy](https://www.jpmorganchase.com/ir/annual-report) [1]
- [Levels.fyi — JPMorgan Chase Product Manager Compensation Data](https://www.levels.fyi/companies/jpmorgan-chase/salaries/product-manager) [2]
- [Bloomberg — JPMorgan's AI Product Strategy and Consumer Banking AI Features](https://www.bloomberg.com/news/articles/jpmorgan-ai-products) [3]
- [Financial Times — Wall Street AI Core Infrastructure Reclassification (Jan 2026)](https://www.ft.com/content/ai-core-infrastructure-banks) [4]
- [Glassdoor — JPMorgan Chase Product Manager Reviews & Salary](https://www.glassdoor.com/Salary/JPMorgan-Chase-Product-Manager-Salaries) [5]
- [CNBC — JPMorgan's $17B Tech Spend and Product Innovation Pipeline](https://www.cnbc.com/jpmorgan-tech-investment) [6]
- [Blind — JPMorgan PM Compensation and Negotiation Data](https://www.teamblind.com/company/JPMorgan-Chase/posts) [7]
