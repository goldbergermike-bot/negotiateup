...
|-------|-------------------|-------------|-----------------|
| Mid (L3-L4) | $175,000–$225,000 | $160,000–$208,000 | £86,000–£110,000 |
| Senior (L5) | $235,000–$330,000 | $215,000–$305,000 | £115,000–£160,000 |
| Staff+ (L6+) | $315,000–$460,000 | $290,000–$425,000 | £152,000–£215,000 |
...
#### Technical Scope — What Edge Inference Platform Engineers Build
...
Edge Inference Platform Engineers build the inference security layer — protecting model weights from extraction, securing inference data in transit, preventing prompt injection attacks, and ensuring that Edge Sovereignty data residency guarantees are cryptographically enforced. The intersection of AI security and edge security is your domain.
...
This is your primary domain. Edge Inference Platform Engineers build the core inference engine within AI Gateway — model routing, intelligent caching, cost optimization, performance monitoring, and Edge Sovereignty compliance. You are the technical owner of the product capability that is driving Cloudflare's fastest revenue growth.

Negotiation language: "I will build the AI Gateway inference engine from the ground up — model routing that minimizes latency across 330+ cities, intelligent caching that reduces inference costs by 40-60%, and Edge Sovereignty compliance that guarantees data residency. This is the product that drove the $42.5M ACV deal, was highlighted in the February 10 earnings, and will define Cloudflare's competitive position in the AI Inference market for the next decade."
...
This lever is unique to the Edge Inference Platform Engineer role. You design the metering, pricing, and cost optimization infrastructure that makes edge AI Inference commercially viable at scale. The $42.5M ACV deal required a pricing model that Cloudflare had never offered before — consumption-based AI Inference pricing with Edge Sovereignty guarantees — and Edge Inference Platform Engineers built the infrastructure to support it.

Negotiation language: "I will design the inference economics platform that enables consumption-based AI pricing with Edge Sovereignty guarantees across 330+ cities. The $42.5M ACV deal was priced using the infrastructure I build. As Cloudflare scales AI Inference revenue — as validated by the February 10 earnings — every dollar flows through my metering and pricing systems."
...
**Counter-Offer**: Present your counter with three pillars: (1) talent scarcity — fewer than 500 engineers worldwide, (2) revenue impact — $42.5M ACV deal flows through your systems, (3) strategic priority — February 10 earnings named AI Inference as the top investment area.
...
- Levels.fyi Cloudflare ML/AI and Platform Engineer compensation data — January 2026
- Cloudflare AI Inference division product roadmap, Edge Sovereignty architecture — Q1 2026
- Blind Cloudflare ML/AI Engineer and Platform Engineer compensation threads — Q4 2025
- Cloudflare 10-K SEC filing, AI Inference revenue segmentation and RSU grants — December 2025
