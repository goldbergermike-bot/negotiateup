...
data_sources:
  ...
  - Glassdoor
  - Blind
negotiation_dna_summary: "`#HighGrading` `#ValueCreation` `#OperationalAlpha` `#PortfolioTechStack` `#AltAssetTech` `#NYSE:KKR` `#$600B+AUM`"
---
...
- [Levels.fyi — KKR Software Engineer Compensation Data](https://www.levels.fyi/companies/kkr/salaries/software-engineer)
- [Glassdoor — KKR Software Engineer Reviews & Salary](https://www.glassdoor.com/Salary/KKR-Software-Engineer-Salaries-E3848.htm)
- [Bloomberg — KKR High Grading & Operational Alpha Strategy 2026](https://www.bloomberg.com/kkr-value-creation)
- [Blind — KKR Technology Compensation Threads](https://www.teamblind.com/company/KKR/)
- [KKR Capstone / Value Creation Team Overview](https://www.kkr.com/businesses/capstone)
