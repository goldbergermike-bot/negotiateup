...
4. **Operational Lever — Incident Response & On-Call Structure:** Security engineers carry critical on-call responsibilities. Negotiate explicit incident response compensation and rotation limits: "I'd like to formalize the security on-call structure, including compensation for off-hours incident response, maximum rotation frequency, and clear escalation policies. Specifically, I'm looking for [incident response pay / rotation caps / escalation SLAs]."
