...
1. **Competing Offer:** "I have an offer from [Google/Meta/Capital One] at $[X] total comp."
2. **Fraud Prevention Impact:** "ML fraud detection saves AmEx billions annually. This revenue impact justifies an RSU of $[target]."
3. **ML Engineering Expertise:** "My experience with [production ML/fraud detection/recommendation systems] commands $[X]."
4. **Sign-On Bridge:** "A sign-on of $[35K-65K] would offset my unvested equity."
