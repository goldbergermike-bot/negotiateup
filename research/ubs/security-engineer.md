...
data_sources:
  ...
  - Blind
  - TeamBlind
negotiation_dna_summary: "`CS Migration` `Efficiency-Impact` `$2.8B IT Savings` `Public Equity (NYSE: UBS)` `$5.7T+ Invested Assets` `Security Architecture Unification` `Regulatory Compliance` `Threat Surface Consolidation`"
---
