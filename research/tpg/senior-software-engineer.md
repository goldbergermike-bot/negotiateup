...
data_sources:
  ...
  - H1B Salary Data
  - Comparably
negotiation_dna_summary: "`Vertical AI` `Commercial Engine` `AI Infrastructure` `Public Equity (NASDAQ: TPG)` `$220B+ AUM` `Technical Leadership` `Portfolio Value Architect` `Revenue-Driving Senior IC`"
---
...
- [Levels.fyi — TPG Senior Software Engineer Compensation Data](https://www.levels.fyi/companies/tpg/salaries/software-engineer) [2]
- [Glassdoor — TPG Senior Engineer Reviews & Salary Reports](https://www.glassdoor.com/Salary/TPG-Salaries-E838823.htm) [3]
- [Blind — Alternative Asset Management Senior Tech Compensation Threads (2024-2025)](https://www.teamblind.com/) [4]
- [TPG Investor Relations — Annual Report & AUM Disclosures](https://shareholders.tpg.com/) [5]
- [H1B Salary Database — TPG Technology Roles](https://h1bdata.info/index.php?em=TPG) [6]
- [Comparably — TPG vs Blackstone vs KKR vs Vista Senior Engineering Compensation](https://www.comparably.com/) [7]
