...
data_sources:
  ...
  - TeamBlind
  - Comparably
negotiation_dna_summary: "`Vertical AI` `Commercial Engine` `AI Infrastructure` `Public Equity (NASDAQ: TPG)` `$220B+ AUM` `Data Pipeline Architecture` `AI Data Foundation` `Portfolio Data Integration` `Revenue-Driving Data Infrastructure`"
---
...
1. **Lever 1 — AI Data Infrastructure Premium**
...
2. **Lever 2 — Cross-Portfolio Data Value**
...
4. **Lever 4 — Data Governance as Commercial Enabler**
...
- [Levels.fyi — Data Engineer Compensation at Financial Services Firms](https://www.levels.fyi/t/data-engineer) [2]
- [Glassdoor — TPG Data Engineering Salary Reports](https://www.glassdoor.com/Salary/TPG-Salaries-E838823.htm) [3]
- [Blind — Data Engineering Compensation at Alternative Asset Managers (2024-2025)](https://www.teamblind.com/) [4]
- [TPG Investor Relations — Annual Report & Data Strategy Disclosures](https://shareholders.tpg.com/) [5]
- [Comparably — DE Compensation: TPG vs Blackstone vs KKR vs Snowflake vs Databricks](https://www.comparably.com/) [6]
- [dbt Labs — Data Engineering Compensation Survey 2024](https://www.getdbt.com/) [7]
