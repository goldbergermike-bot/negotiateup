...
data_sources:
  ...
  - Glassdoor
  - Blind
negotiation_dna_summary: "`NYSE: GPN` `Worldpay Re-Integration` `Payment Orchestration` `Unified Commerce` `Program Execution` `Cross-Functional Leadership`"
---
...
**Evidence & Sources:**
1. Levels.fyi — Technical Program Manager compensation benchmarks across fintech and FAANG, 2025-2026
2. Global Payments 2025 10-K Filing (SEC EDGAR) — Integration program structure, milestone disclosures, and synergy timelines
3. Glassdoor — Global Payments TPM salary reports, 2025-2026
4. Blind — Verified TPM compensation threads in payment technology and enterprise tech
5. Global Payments Q4 2025 Earnings Call — Integration program progress and execution timeline updates
