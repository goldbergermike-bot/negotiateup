...
Data Scientists power the analytical core of SoFi's LTV acceleration engine:
...
3. **Credit Risk Optimization:** In lending, data science IS the product. Improved credit models directly translate to better risk-adjusted returns, lower default rates, and expanded access to credit. A data scientist who improves SoFi's lending model creates value measured in tens of millions of dollars in annual credit performance.

4. **Galileo Analytics Platform:** Data scientists contributing to Galileo's analytics capabilities create enterprise value beyond SoFi. Building fraud detection models, transaction analytics, or risk scoring for the BaaS platform affects 130M+ accounts and generates enterprise revenue.
...
1. **Lever: Financial Modeling Expertise**
...
2. **Lever: Cross-Product Analytics Capability**
...
3. **Lever: Production ML Experience**
...
4. **Lever: Regulatory & Explainability Expertise**
...
- [SoFi 10M+ Members & Data Platform](https://www.sofi.com/press/)
- [Galileo Analytics & Data Products](https://www.galileo-ft.com/)
- [Levels.fyi SoFi Data Scientist Compensation](https://www.levels.fyi/companies/sofi/salaries/data-scientist)
- [Glassdoor SoFi Data Scientist Salaries](https://www.glassdoor.com/Salary/SoFi-Data-Scientist-Salaries)
