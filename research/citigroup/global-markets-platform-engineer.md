...
1. **Competing Offer:** "I have an offer from [Goldman Sachs/Citadel Securities/Jane Street] at $[X] total comp for a markets technology role. I'm drawn to Citi's global platform and scope, but the compensation gap is significant. Can we increase the base to $[target] and guarantee the first-year bonus at [X]%?"
2. **Revenue Attribution:** "Global Markets technology directly enables [X] in daily trading revenue. Given this direct revenue impact, I believe a guaranteed first-year bonus of [X]% and a base of $[target] is well-justified."
3. **Low-Latency Expertise:** "My experience building [low-latency trading systems/real-time risk engines/market data platforms] is directly applicable and commands $[X] at electronic market makers and quant funds. I'd like the total comp to reflect that market rate."
4. **Sign-On Bridge:** "I have $[X]K in unvested deferred comp/equity at my current firm. A sign-on bonus of $[50K-90K] would make the transition financially neutral."
