...
data_sources:
  ...
  - Blind
  - Crunchbase
negotiation_dna_summary: "`Private` `Real-Time Yield` `Fintech` `Spend Management` `European Scale` `Pre-IPO` `Cash-Management Yield` `Machine Learning` `AI Infrastructure`"
---
...
**Evidence & Sources:**
1. Levels.fyi — ML/AI Engineer compensation at European fintechs (2025-2026)
2. Glassdoor — Pleo ML Engineer salary reports
3. Blind — Fintech ML/AI compensation threads
4. Crunchbase — Pleo $4.7B valuation and investor profile
5. Pleo Engineering Blog — ML/AI capabilities and product intelligence initiatives
