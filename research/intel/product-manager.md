...
level_mapping:
  internal: null
  raw: Intel Product Manager (Grade 7-8) = AMD Product Manager = NVIDIA Product Manager = Google L5 Product Manager
data_sources:
  - Levels.fyi
...
- [Intel Foundry Services — External Customer Strategy](https://www.intel.com/content/www/us/en/foundry/overview.html)
- [Levels.fyi — Intel Product Manager Compensation](https://www.levels.fyi/companies/intel/salaries/product-manager)
