...
data_sources:
  - Glassdoor
negotiation_dna_summary: "`Private` `MENA Facilitator` `Payment Infrastructure` `Dubai HQ` `Growth-Stage Fintech` `Options Equity` `Cross-Functional Delivery` `Program Execution`"
---
...
**Evidence & Sources:**
1. Robert Half UAE 2026 Technology Salary Guide — TPM compensation for Dubai fintech sector
2. Hays GCC Salary Guide 2026 — Program management compensation in payment technology across UAE and KSA
3. Michael Page UAE 2026 — TPM salaries at growth-stage fintechs in the Gulf region
4. Glassdoor UAE — Technical Program Manager salaries at Checkout.com and Careem in Dubai
5. PMI Middle East Salary Survey 2025 — Technical program management compensation trends in Gulf fintech
