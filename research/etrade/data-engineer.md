...
> "I have offers from [Databricks/Snowflake/Netflix] for data engineering roles at $X total comp, and from [Coinbase/Robinhood] for crypto data engineering at $Y. E*TRADE's role is the most technically interesting because I would be building the bridge between institutional financial data and crypto market data. I need $Z total comp to choose E*TRADE over these alternatives."
...
1. Morgan Stanley 2025 10-K Filing — Data infrastructure organization and technology investment (SEC EDGAR)
2. Levels.fyi — Morgan Stanley Data Engineer verified compensation data, 2024-2026
3. Glassdoor — E*TRADE Data Engineer salary reports, 2024-2026
4. Databricks / Snowflake Career Pages — Data Engineer compensation bands for competitive benchmarking
5. Coinbase Engineering Blog — Crypto data pipeline architecture and data engineering practices
6. FINRA CAT (Consolidated Audit Trail) — Data reporting requirements for broker-dealers
7. Morgan Stanley Technology Division — Published data engineering role descriptions and compensation ranges
