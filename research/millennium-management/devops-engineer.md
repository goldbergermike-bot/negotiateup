...
data_sources:
  - Levels.fyi
negotiation_dna_summary: "`Pod Structure` `PnL Percentage` `Impact Multiplier` `Multi-Manager Platform` `Infrastructure Reliability` `Pod Deployment` `CI/CD` `Direct Attribution`"
---
...
- [Millennium Management Infrastructure Operations — Institutional Investor](https://www.institutionalinvestor.com/millennium-management)
- [DevOps Engineer Compensation at Hedge Funds — Options Group](https://www.optionsgroup.com/compensation-reports)
- [Trading Infrastructure Compensation 2024-2025 — Heidrick & Struggles](https://www.heidrick.com/hedge-fund-compensation)
- [SRE and DevOps Roles at Multi-Manager Funds — eFinancialCareers](https://www.efinancialcareers.com/devops-hedge-fund)
- [Infrastructure Reliability in Financial Services — Greenwich Associates](https://www.greenwich.com/trading-infrastructure)
- [DevOps Salary Benchmarks in Finance — Levels.fyi](https://www.levels.fyi/companies/millennium-management)
