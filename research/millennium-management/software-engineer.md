...
data_sources:
  - Levels.fyi
negotiation_dna_summary: "`Pod Structure` `PnL Percentage` `Impact Multiplier` `Multi-Manager Platform` `Trading Infrastructure` `Direct Attribution`"
---
...
- [Millennium Management Overview — Institutional Investor](https://www.institutionalinvestor.com/millennium-management)
- [Multi-Manager Hedge Fund Compensation Trends 2024-2025 — Heidrick & Struggles](https://www.heidrick.com/hedge-fund-compensation)
- [Hedge Fund Technology Compensation Report — Options Group](https://www.optionsgroup.com/compensation-reports)
- [Millennium Management AUM and Structure — Bloomberg](https://www.bloomberg.com/millennium-management)
- [Pod-Based Hedge Fund Technology Roles — eFinancialCareers](https://www.efinancialcareers.com/pod-hedge-fund-tech)
- [Alternative Investment Technologist Salary Data — Levels.fyi](https://www.levels.fyi/companies/millennium-management)
