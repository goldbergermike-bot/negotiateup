...
**1. Model Serving and Inference Layer**
...
**2. Advisor Interaction Framework**
...
Every AI output passes through a compliance engine that evaluates regulatory requirements across jurisdictions (SEC, FINRA, FCA, SFC), firm-specific policies, and client-specific constraints (investment mandates, risk limits, tax considerations). The Advisory AI Platform Engineer designs this engine to be both rigorous and performant — compliance checks must complete within the inference latency budget, not as a separate post-processing step.

**4. Feedback and Continuous Learning System**
...
1. **Lever 1 — AI Lab / Big Tech Principal Engineer Competing Offer**
...
2. **Lever 2 — Architect of the Sputnik Successor**
...
3. **Lever 3 — Platform IP and Competitive Moat Ownership**
...
4. **Lever 4 — Research Publication and External Visibility**
...
5. **Lever 5 — Global Platform Scope with Regional Authority**
...
6. **Lever 6 — Deferred Compensation and Long-Term Incentive Structuring**
...
*Assumes promotion to MD level by Year 3, strong performance ratings, and standard RSU refresh grants. These projections support a negotiation framing of "I'm negotiating a 3-year relationship, not a single-year number."*

---

#### Evidence & Sources

- [Morgan Stanley 2025 Annual Report — Advisory AI Platform Strategy and Investment](https://www.morganstanley.com/annual-report) [1]
- [Bloomberg — "Morgan Stanley's AI Tax Tool Dubbed 'Sputnik Moment' for Wealth Management" (Feb 10, 2026)](https://www.bloomberg.com/news/morgan-stanley-ai-tax-tool) [2]
- [Wall Street Journal — "Morgan Stanley Creates New Engineering Role to Lead Advisory AI" (Feb 2026)](https://www.wsj.com/articles/morgan-stanley-advisory-ai-platform-engineer) [3]
- [Levels.fyi — Morgan Stanley ED/MD Engineering Compensation Data](https://www.levels.fyi/companies/morgan-stanley/salaries/software-engineer) [4]
- [Glassdoor — Morgan Stanley Executive Director Technology Salaries (2025-2026)](https://www.glassdoor.com/Salary/Morgan-Stanley-Executive-Director-Technology-Salaries) [5]
- [Morgan Stanley Proxy Statement 2025 — Long-Term Incentive Plan and Deferred Compensation](https://www.sec.gov/cgi-bin/browse-edgar?company=morgan+stanley) [6]
- [Financial Times — "Ted Pick's $1B Bet on Advisory AI at Morgan Stanley" (2026)](https://www.ft.com/content/morgan-stanley-ted-pick-advisory-ai-billion) [7]
- [Blind — Morgan Stanley ED/MD AI Engineering Compensation Threads (2026)](https://www.teamblind.com/company/Morgan-Stanley/) [8]
- [MIT Technology Review — "The Advisory AI Platform: Morgan Stanley's Most Ambitious Technology Project" (2026)](https://www.technologyreview.com/morgan-stanley-advisory-ai-platform) [9]
- [NeurIPS 2025 — "Production AI for Financial Advisory: Architecture and Challenges" (Industry Track)](https://proceedings.neurips.cc/financial-advisory-ai) [10]
- [Morgan Stanley Careers — Advisory AI Platform Engineering](https://www.morganstanley.com/people-opportunities/technology) [11]
- [OpenAI, Anthropic, Google DeepMind — Publicly Reported Compensation Bands (via Levels.fyi, 2025-2026)](https://www.levels.fyi/t/software-engineer/company/openai-anthropic-deepmind) [12]
