...
data_sources:
  - Levels.fyi
  - Blind
negotiation_dna_summary: "`63% Pay Hike` `Alpha Architect` `$600K+ Per-Head` `All-Cash Comp` `Private Partnership` `Technical Leadership` `OCaml Engineering Culture` `Trading Infrastructure Management`"
---
...
- [Engineering Manager Compensation in Finance — Levels.fyi, 2025-2026](https://www.levels.fyi)
- [Jane Street Engineering Culture — Jane Street Careers](https://www.janestreet.com/join-jane-street)
- [Quantitative Fund EM Salary Survey — efinancialcareers, 2026](https://www.efinancialcareers.com)
- [FAANG vs Finance EM Compensation — Blind, 2026](https://www.teamblind.com)
