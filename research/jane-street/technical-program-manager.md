...
data_sources:
  - Levels.fyi
  - Blind
negotiation_dna_summary: "`63% Pay Hike` `Alpha Architect` `$600K+ Per-Head` `All-Cash Comp` `Private Partnership` `Trading Program Execution` `Cross-Functional Coordination` `Infrastructure Delivery`"
---
...
- [Technical Program Manager Compensation in Finance — Levels.fyi, 2025-2026](https://www.levels.fyi)
- [Jane Street Program Delivery Culture — Jane Street Careers](https://www.janestreet.com/join-jane-street)
- [TPM Roles at Quantitative Funds — efinancialcareers, 2026](https://www.efinancialcareers.com)
- [Finance vs Tech TPM Compensation — Blind, 2026](https://www.teamblind.com)
