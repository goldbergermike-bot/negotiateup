...
1. **Share Count Over Dollar Value:** "I'd like to negotiate on share count rather than dollar value. Given the $25B secondary valuation, I can calculate the real worth myself — and I want to ensure my equity stake reflects my contribution to the platform."
2. **Competing Offer Leverage:** "I have a competing offer from [Company] at $X total comp. Vast Data's equity upside is compelling, but I need the base and share count to bridge the gap so I'm not taking a discount to join."
3. **Signing Bonus to Bridge Year-One Gap:** "Since equity vesting typically has a one-year cliff, I'd like a signing bonus of $15K–$25K to bridge the first-year compensation gap compared to my current role."
4. **Remote Work Premium:** "If the role is based in New York but I'm working remotely, I'd expect the equity component to remain pegged to New York levels, since my output is location-independent."
