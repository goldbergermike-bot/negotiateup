...
export function getOfferPrompt(data, researchContext = null) {
  const researchSection = researchContext ? `
## COMPANY & ROLE RESEARCH DATA (VERIFIED SOURCE — USE AS PRIMARY REFERENCE)
The following is verified compensation and negotiation intelligence for this company and role.
Use this data as your PRIMARY source for Sections 2, 4, 5, and 6. Do NOT contradict these numbers.
If the research data covers a topic, use it verbatim or paraphrase it — do not substitute your own estimates.
...
${researchContext ? '- IMPORTANT: Use the compensation table from the COMPANY & ROLE RESEARCH DATA above as your primary market data source. Cite the specific ranges provided.' : ''}
...
${researchContext ? '- IMPORTANT: Anchor your counter-offer numbers to the compensation ranges from the COMPANY & ROLE RESEARCH DATA above. Use the research data\'s negotiation levers and strategies.' : ''}
...
${researchContext ? '- IMPORTANT: Incorporate the "Global Levers" and "Negotiate Up Strategy" from the research data into scripts and pushback responses.' : ''}

### SECTION 6: COMPANY INTELLIGENCE
About ${data.companyName}:
${researchContext ? `- Use the COMPANY & ROLE RESEARCH DATA above as your primary source for this section
- Include the company's Negotiation DNA, level mapping, and career credential insights from the research
- Supplement with your general knowledge only for topics NOT covered in the research data` : `- Compensation philosophy
...
export function getRaisePrompt(data, researchContext = null) {
  const researchSection = researchContext ? `
## COMPANY & ROLE RESEARCH DATA (VERIFIED SOURCE — USE AS PRIMARY REFERENCE)
The following is verified compensation and negotiation intelligence for this company and role.
Use this data as your PRIMARY source for Sections 2, 4, and 6. Do NOT contradict these numbers.
If the research data covers a topic, use it verbatim or paraphrase it — do not substitute your own estimates.
...
${researchContext ? '- IMPORTANT: Use the compensation table from the COMPANY & ROLE RESEARCH DATA above as your primary market data source. Cite the specific salary ranges and total comp figures provided.' : ''}
...
${researchContext ? '- IMPORTANT: Anchor your salary target recommendations to the compensation ranges from the COMPANY & ROLE RESEARCH DATA above.' : ''}
...
${researchContext ? '- IMPORTANT: Incorporate negotiation levers and strategies from the research data into objection responses.' : ''}
