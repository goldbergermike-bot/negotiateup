// ============================================
// NegotiateUp — AI Prompt Templates
// ============================================
...
${data.companyIntel ? `## ${data.companyIntel}` : ''}
...
${data.companyIntel
    ? '- Use the VERIFIED COMPANY INTELLIGENCE provided above as the primary source. Expand on it with additional relevant insights.'
